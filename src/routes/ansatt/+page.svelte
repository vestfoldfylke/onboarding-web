...
<main>
  ...
  <div class="centerstuff">
    ...
    <CardButton header={'Tilbakestill passord og aktiver bruker'} imgPath={key} imgAlt={'Ikon bilde av en nøkkel'} gotoPath={''} paragraph={'Krever pålogging med MinID eller BankID, deretter vil du få et engangspassord på sms'} boolValue={false} loading={loading === 'resetpassword'} func={() => redirect('resetpassword')}/>
  </div>
</main>
